...
export const AppMentorImmer = () => {
    ...
    const handleNameChange = () => {
        ...
        updatePerson((person) => {
            const mentor = person.mentors.find((m) => m.name === selectedName);
            mentor.name = changedName;
        })
    }
    ...
    const handleAddMentor = () => {
        ...
        updatePerson((person) => {
            person.mentors.push({name: newMentorName, job: newMentorJob});
        })
    }
    ...
    const handleDeleteMentor = () => {
        ...
        updatePerson((person) => {
            const index = person.mentors.findIndex((mentor) => mentor.name === deleteMentorName);
