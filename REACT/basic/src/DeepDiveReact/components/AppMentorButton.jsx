    ...
    return (
        <div 
            ...
            <div className='btnGroup'>
                <Button className="nameChange" type='button' onClick={handleNameChange} text='멘토이름 변경' />
                <Button className='addMentor' type='button'onClick={handleAddMentor} text='멘토 추가' />
                <Button className="deleteMentor" type='button' onClick={handleDeleteMentor} text='멘토 삭제' />
            </div>
        </div>
    );
};
...
const Button = memo((({type, text, onClick}) => {
    console.log('Button', text, 're-rendering');
    const result = useMemo(() => calcSomething(), []);
    console.log(result);    
